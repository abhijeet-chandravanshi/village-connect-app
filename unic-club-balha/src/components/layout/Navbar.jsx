...
function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-white/80 dark:bg-earth-900/80 backdrop-blur-md border-b border-cream-200 dark:border-earth-700 transition-colors duration-300">
